export default {
  ...
  // Printers page
  printers: {
    fileAccessAvailable: 'Acesso aos arquivos da impressora',
    fileAccessOfflineHint: 'O status ao vivo está offline, mas ainda é possível navegar pelo armazenamento via FTP.',
    addPreflight: {
